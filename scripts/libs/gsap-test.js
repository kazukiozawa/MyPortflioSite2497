document.addEventListener('DOMContentLoaded', () => {
    ...
    menuBtn.addEventListener('click', () => {
      if (!isOpen) {
        ...
        gsap.to(spans[0], { y: 0, rotation: 0, duration: 0.6 });
        gsap.to(spans[1], { opacity: 1, duration: 0.6 });
        gsap.to(spans[2], { y: 0, rotation: 0, duration: 0.6 });
        gsap.to(menuBtn, { backgroundColor: '#ffffff', duration: 0.4 });
    }
      isOpen = !isOpen;
    });
  });
